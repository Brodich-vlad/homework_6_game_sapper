...
export const dataPagesMobile = [
	{
		...
		paramGame: { numCol: 6, maxMines: 0.1, colSize: 5, numTerms: 6 }
	},
	{
		id: 'rivne',
		title: 'рівне',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Coat_of_arms_Rivne.svg/800px-Coat_of_arms_Rivne.svg.png',
	...
	},
	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Coat_of_Arms_of_Zhytomyr.svg/800px-Coat_of_Arms_of_Zhytomyr.svg.png',

		paramGame: { numCol: 7, maxMines: 0.1, colSize: 4, numTerms: 7 }
	},
	{
		id: 'кyiv',
		title: 'київ',
		...
		paramGame: { numCol: 7, maxMines: 0.15, colSize: 4, numTerms: 9 }
	},
	{
		id: 'сhernihiv',
		title: 'чернігів',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Coat_of_Arms_of_Chernihiv.svg/800px-Coat_of_Arms_of_Chernihiv.svg.png',

		paramGame: { numCol: 7, maxMines: 0.2, colSize: 4, numTerms: 12 }
	},
	{
		id: 'sumy',
		title: 'суми',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/%D0%93%D0%B5%D1%80%D0%B1_%D0%BC%D1%96%D1%81%D1%82%D0%B0_%D0%A1%D1%83%D0%BC%D0%B8.svg/800px-%D0%93%D0%B5%D1%80%D0%B1_%D0%BC%D1%96%D1%81%D1%82%D0%B0_%D0%A1%D1%83%D0%BC%D0%B8.svg.png',

		paramGame: { numCol: 7, maxMines: 0.18, colSize: 4, numTerms: 12 }
	},
	{
		id: 'кharkiv',
		title: 'харків',
		...
		paramGame: { numCol: 7, maxMines: 0.19, colSize: 4, numTerms: 15 }
	},
	{
		id: 'luhansk',
		title: 'луганськ',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Coat_of_arms_of_Luhansk.svg/800px-Coat_of_arms_of_Luhansk.svg.png',

		paramGame: { numCol: 7, maxMines: 0.3, colSize: 4, numTerms: 25 }
	},
	{
		id: 'donetsk',
		title: 'донецьк',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Greater_Coat_of_Arms_of_Donetsk_%281995%29.svg/800px-Greater_Coat_of_Arms_of_Donetsk_%281995%29.svg.png',
	...
	},
	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Coat_of_arms_of_Dnipro.svg/800px-Coat_of_arms_of_Dnipro.svg.png',

		paramGame: { numCol: 7, maxMines: 0.12, colSize: 4, numTerms: 10 }
	},
	{
		id: 'poltava',
		title: 'полтава',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Poltava_gerb_right.svg/800px-Poltava_gerb_right.svg.png',
	...
	},
	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/COA_Cherkasy%2C_Cherkaska%2C_Ukraine.svg/800px-COA_Cherkasy%2C_Cherkaska%2C_Ukraine.svg.png',

		paramGame: { numCol: 6, maxMines: 0.12, colSize: 5, numTerms: 8 }
	},
	{
		id: 'kropyvnytskyi',
		title: 'кропивницький',
		...
		infoLink:
			'https://uk.wikipedia.org/wiki/%D0%9A%D1%80%D0%BE%D0%BF%D0%B8%D0%B2%D0%BD%D0%B8%D1%86%D1%8C%D0%BA%D0%B8%D0%B9',
		...
		paramGame: { numCol: 7, maxMines: 0.16, colSize: 4, numTerms: 15 }
	},
	{
		id: 'vinnitsa',
		title: 'вінниця',
		...
		paramGame: { numCol: 7, maxMines: 0.15, colSize: 4, numTerms: 10 }
	},

	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Coat_of_Arms_of_Khmelnitsky.svg/800px-Coat_of_Arms_of_Khmelnitsky.svg.png',
...

	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Coat_of_arms_of_Ternopil.svg/800px-Coat_of_arms_of_Ternopil.svg.png',

		paramGame: { numCol: 6, maxMines: 0.15, colSize: 4, numTerms: 8 }
	},
	{
		id: 'lviv',
		title: 'львів',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Coat_of_arms_of_Lviv.svg/800px-Coat_of_arms_of_Lviv.svg.png',

		paramGame: { numCol: 6, maxMines: 0.15, colSize: 5, numTerms: 8 }
	},
	{
		id: 'uzhhorod',
		title: 'ужгород',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Coat_of_arms_of_the_city_of_Uzhhorod.svg/800px-Coat_of_arms_of_the_city_of_Uzhhorod.svg.png',

		paramGame: { numCol: 6, maxMines: 0.1, colSize: 5, numTerms: 8 }
	},
	{
		id: 'ivano-frankivsk',
		...
		infoLink:
			'https://uk.wikipedia.org/wiki/%D0%86%D0%B2%D0%B0%D0%BD%D0%BE-%D0%A4%D1%80%D0%B0%D0%BD%D0%BA%D1%96%D0%B2%D1%81%D1%8C%D0%BA',
	...
	},
	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Coat_of_arms_of_Chernivtsi.svg/800px-Coat_of_arms_of_Chernivtsi.svg.png',
	...
	},
	{
		...
		infoGame:
			'Середній рівень гри. Небезпечні ділянки складають приблизно 15%. Є залишки ракет та морські міни. Вдалого розмінування!',

		img: [imgBomb_1, imgBomb_4],

		imgPrapor: 'https://upload.wikimedia.org/wikipedia/commons/4/49/Coat_of_Arms_of_Odesa.svg',

		paramGame: { numCol: 7, maxMines: 0.15, colSize: 4, numTerms: 15 }
	},
	{
		id: 'мykolaiv',
		title: 'миколаїв',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/Coat_of_arms_of_Nikolayev.svg/800px-Coat_of_arms_of_Nikolayev.svg.png',

		paramGame: { numCol: 7, maxMines: 0.25, colSize: 4, numTerms: 20 }
	},
	{
		id: 'kherson',
		title: 'херсон',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Coat_of_arms_of_Kherson.svg/800px-Coat_of_arms_of_Kherson.svg.png',
	...
	},
	{
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/%D0%93%D0%B5%D1%80%D0%B1_%D0%97%D0%B0%D0%BF%D0%BE%D1%80%D0%BE%D0%B6%D1%8C%D1%8F_2003_%D0%B3%D0%BE%D0%B4%D0%B0.svg/800px-%D0%93%D0%B5%D1%80%D0%B1_%D0%97%D0%B0%D0%BF%D0%BE%D1%80%D0%BE%D0%B6%D1%8C%D1%8F_2003_%D0%B3%D0%BE%D0%B4%D0%B0.svg.png',

		paramGame: { numCol: 7, maxMines: 0.2, colSize: 4, numTerms: 20 }
	},
	{
		id: 'simferopol',
		title: 'сімферополь',
		...
		imgPrapor:
			'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/COA_Simferopol.svg/800px-COA_Simferopol.svg.png',
	...
	},
	{
		...
		paramGame: { numCol: 6, maxMines: 0.15, colSize: 5, numTerms: 6 }
	}
];